...
class _JopScreenState extends State<JopScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => JopCubit()
        ..getAllJopAlerts()
        ..getAllJopNew(),
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: JopCubit.get(context).jopAlertsList.length,
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${JopCubit.get(context).jopAlertsList[index].values.single.jopName}',
                                    style: TextStyle(
                                      fontFamily: 'Tajawal',
                                      fontSize: 12,
                                      fontWeight: FontWeight.w400,
                                  ...
                                  Text(
                                    '${JopCubit.get(context).jopAlertsList[index].values.single.category}',
                                    style: TextStyle(
                                      fontFamily: 'Tajawal',
                                      fontWeight: FontWeight.w400,
                                      fontSize: 10,
                  ...
                  SizedBox(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: JopCubit.get(context).jopNewsList.length,
                      itemBuilder: (context, index) {
                        return Container(
                                  ...
                                  children: [
                                    ...
                                    ListTile(
                                      leading: GestureDetector(
                                        onTap: (){
                                          //JopCubit.get(context).getAllJopDetails(JopCubit.get(context).jopNewsList[index].values.single.id);
                                          print("*/*/*/*/*/**/*/*/*/*//**/*/*/*/*/**//**/*//*/*/*/*/*/*/*/*/*//*/*/**//*/*");
                                            print(JopCubit.get(context).jopNewsList[index].values.single.id);
                                              navigateTo(context, jop_details(id:JopCubit.get(context).jopNewsList[index].values.single.id));
                                        },
                                        child: Container(width: 30,height: 30,color: AppColor.main,),
                                        // child: CircleAvatar(
                                      ...
                                      title: Text(
                                        "${JopCubit.get(context).jopNewsList[index].values.single.jopName}",
                                        style: TextStyle(
                                          fontFamily: 'Tajawal',
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                "${JopCubit.get(context).jopNewsList[index].values.single.time}",
                                                style: TextStyle(
                                                  fontFamily: 'Tajawal',
                                                  fontSize: 9,
                                                  fontWeight: FontWeight.w500,
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                "${JopCubit.get(context).jopNewsList[index].values.single.toPrice}",
                                                style: TextStyle(
                                                  fontFamily: 'Tajawal',
                                                  fontSize: 9,
                                                  fontWeight: FontWeight.w500,
                                              ...
                                              Text(
                                                " - ${JopCubit.get(context).jopNewsList[index].values.single.fromPrice}",
                                                style: TextStyle(
                                                  fontFamily: 'Tajawal',
                                                  fontSize: 9,
                                                  fontWeight: FontWeight.w500,
                                              ...
                                              Text(
                                                " ${JopCubit.get(context).jopNewsList[index].values.single.typePrice} ",
                                                style: TextStyle(
                                                  fontFamily: 'Tajawal',
                                                  fontSize: 9,
                                                  fontWeight: FontWeight.w500,
